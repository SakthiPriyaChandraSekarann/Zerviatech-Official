    ...
    <main className="bg-[#f6f6f8] min-h-screen text-gray-800 overflow-x-hidden">
      ...
      <div className="bg-[#f5f6f8] py-10 sm:py-14 md:py-16 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-6 sm:gap-8">
          ...
          >
            {/* <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-black leading-tight mb-4 sm:mb-6"> */}
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-6 max-w-md sm:max-w-lg mx-auto">
              ...
              vision. Our editorial approach to analytics ensures every insight
              is actionable, strategic, and visually profound.
            </p>
      ...
      <div className="bg-[#f5f6f8] py-10 sm:py-14 md:py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, y: 0 }}
          >
            Engineering powerful digital platforms with performance,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 auto-rows-auto lg:auto-rows-[220px]">
            ...
            >
              <div>
                <img src="/Full Stack.png" className="w-8 h-8 sm:w-10 sm:h-10 mb-3 sm:mb-4" />
                <h3 className="text-base sm:text-xl font-semibold text-[#1c2541] mb-2">
                  Full Stack Development
                </h3>
                <p className="text-sm sm:text-base text-gray-600">
                  End-to-end development tailored to your business needs. We
                  build robust frontend and backend systems that ensure
              ...
              <img
                ...
                className="rounded-lg w-full h-28 sm:h-48 object-cover object-center"
              />
            </motion.div>
            ...
            >
              ...
              <p className="text-sm sm:text-base text-gray-600">
                Speed and reliability at every level. We optimize applications
                for fast load times, scalability, and consistent performance.
              </p>
            ...
            >
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">
                  We create tailored web solutions that solve real business
                  challenges. From dashboards to enterprise platforms,
              ...
              <img
                src="/Custom Web Applications.png"
                className="rounded-lg w-full h-24 sm:h-32 object-cover mt-3 sm:mt-4"
              />
            </motion.div>
            ...
            >
              ...
              <p className="text-sm sm:text-base text-gray-200">
                Seamless connectivity across platforms. We integrate third-party
                services, APIs, and internal systems for smooth operations.
              </p>
            </motion.div>
          </div>
        </div>
