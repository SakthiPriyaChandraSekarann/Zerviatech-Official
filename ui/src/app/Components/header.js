    ...
    <nav className="w-full bg-white px-4 sm:px-6 py-4 border-b border-gray-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          ...
          <Link href="/blogs" className={getLinkStyle("/Blogs")}>
            Blog
          </Link>

          <Link href="/Careers" className={getLinkStyle("/Careers")}>
            Careers
          </Link>
      ...
      {isOpen && (
        <div className="lg:hidden mt-4 pb-6 space-y-3 border-t pt-4">
          ...
          <Link href="/Blogs" className={getMobileLinkStyle("/Blogs")} onClick={() => setIsOpen(false)}>
            Blog
          </Link>

          
          <Link href="/Careers" className={getMobileLinkStyle("/Careers")} onClick={() => setIsOpen(false)}>
            Careers
          </Link>
