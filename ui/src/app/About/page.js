...
const AboutPage = () => {
  return (
    <div className="min-h-screen bg-white text-black selection:bg-emerald-100 font-sans">
      ...
      {/* Hero Section */}
      <section className="px-4 py-20 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-md">
            At Zervia Tech Solutions, we don't just build software; we engineer ecosystems. 
            Founded on the principle of editorial clarity in technology, we blend architectural 
      ...
      <section className="px-8 py-12 max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
        <div className="bg-gray-50 border border-gray-100 p-12 rounded-[2.5rem] hover:bg-white hover:shadow-xl hover:border-emerald-200 transition-all duration-500 group">
          ...
          <p className="text-gray-500 leading-relaxed text-sm md:text-base">
            To empower businesses globally by delivering high-fidelity digital solutions 
            that bridge the gap between complex engineering and intuitive human experiences. 
            We strive for excellence in every line of code we ship.
          </p>
        </div>
        ...
        <div className="bg-gray-50 border border-gray-100 p-12 rounded-[2.5rem] hover:bg-white hover:shadow-xl hover:border-emerald-200 transition-all duration-500 group">
          ...
          <p className="text-gray-500 leading-relaxed text-sm md:text-base">
            To be the global benchmark for editorial-grade software architecture, 
            where design and technology exist in perfect symmetry, fostering a world 
            connected by seamless and beautiful digital infrastructure.
          </p>
        </div>
      </section>
      ...
      <section className="px-8 py-24 text-center">
        <h2 className="text-4xl font-bold mb-6 tracking-tighter">Why Partners Choose Zervia</h2>
        ...
        <div className="grid md:grid-cols-3 gap-0 max-w-6xl mx-auto border border-gray-200 rounded-[2rem] overflow-hidden bg-white shadow-sm">
          ...
          <div className="p-12 border-b md:border-b-0 md:border-r border-gray-100 hover:bg-gray-50 transition-colors">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">Every project undergoes a rigorous architectural audit to ensure long-term performance.</p>
          </div>
          ...
          <div className="p-12 border-b md:border-b-0 md:border-r border-gray-100 bg-gray-50/50 relative">
            ...
            <h4 className="text-lg font-bold mb-4 text-emerald-600">Strategic Innovation</h4>
            <p className="text-gray-600 text-sm leading-relaxed font-medium">We don't follow trends, we set them. Our tech stack leverages the latest in edge computing and AI.</p>
          </div>
          ...
          <div className="p-12 hover:bg-gray-50 transition-colors">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">Your vision is our blueprint. We work synchronously with your team as a true partner.</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-8 py-24 max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
        <div className="order-2 lg:order-1">
          <h2 className="text-5xl font-extrabold mb-8 leading-tight tracking-tighter">Our Culture of <br />Excellence</h2>
          <p className="text-gray-600 mb-12 text-lg leading-relaxed max-w-lg">
            Beyond the screens and the code, Zervia is a collective of thinkers, designers, 
            and engineers who share a passion for high-end digital craftsmanship. 
          </p>
          <div className="grid grid-cols-2 gap-y-12 gap-x-8">
            {[
              ...
              <div key={idx} className="border-l-2 border-emerald-500 pl-6">
                <div className="text-4xl font-black text-black mb-1">{stat.val}</div>
                <div className="text-[10px] text-emerald-600 font-bold uppercase tracking-[0.2em]">{stat.lab}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="order-1 lg:order-2 grid grid-cols-6 grid-rows-6 gap-4 h-[500px]">
          <div className="col-span-4 row-span-4 rounded-[2rem] overflow-hidden border border-gray-200 relative shadow-sm">
            <img src="https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale hover:grayscale-0 transition duration-700" alt="Team" />
          </div>
          <div className="col-span-2 row-span-3 rounded-[2rem] overflow-hidden border border-gray-200 relative shadow-sm">
            <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale hover:grayscale-0 transition duration-700" alt="Collaboration" />
          </div>
          <div className="col-span-3 row-span-2 rounded-[2rem] overflow-hidden border border-gray-200 relative shadow-sm">
            <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale hover:grayscale-0 transition duration-700" alt="Office" />
          </div>
          <div className="col-span-3 row-span-3 rounded-[2rem] overflow-hidden border border-gray-200 relative shadow-sm">
            <img src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale hover:grayscale-0 transition duration-700" alt="Focus" />
          </div>
        </div>
      </section>
